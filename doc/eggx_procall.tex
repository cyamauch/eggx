...
\begin{document}
%\title{\vspace*{-5mm}{\large Easy and Gratifying Graphics library for X11}\\EGGX/ProCALL version 0.95}
...
\begin{center}
{\bf \huge EGGX/ProCALL version 0.95}
\end{center}
...
\begin{center}
{\Large \it Presented by Chisato Yamauchi, Aug. 28, 2021}
\end{center}
...
\item
      \verb|MAX_WINDOW_SIZE|

      A maximum size for resizing the window is set.
      This attribute is disabled by default.
      %グラフィックス領域の大きさを越えたウィンドゥサイズへのリサイズを禁止します。
